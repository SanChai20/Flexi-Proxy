      ...
      <Card className="shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">
            {dict?.home?.title || "Welcome to FlexiProxy"}
          </CardTitle>
          <CardDescription className="text-base mt-2">
            {dict?.home?.subtitle ||
              "AI Service Proxy Gateway, Breaking Regional & Pricing Barriers"}
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
          <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg border border-border hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {dict?.home?.feature1Title || "Fast & Reliable"}
            </h3>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg border border-border hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {dict?.home?.feature2Title || "Secure"}
            </h3>
            <p className="text-muted-foreground text-sm">
          ...
          <div className="flex flex-col items-center text-center p-6 bg-card rounded-lg border border-border hover:shadow-md transition-shadow">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {dict?.home?.feature3Title || "Easy Setup"}
            </h3>
            <p className="text-muted-foreground text-sm">
              {dict?.home?.feature3Subtitle ||
                "Simple setup with various providers"}
            </p>
          </div>
        </CardContent>
      </Card>
