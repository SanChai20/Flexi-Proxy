...
export const metadata: Metadata = {
    title: 'Login - Lumicon AI',
    description: 'Sign in to your Lumicon AI account',
    robots: {
        index: false,
        follow: false,
        googleBot: {
...
const verifyToken = async (token: string | null) : Promise<boolean> => {
    ...
    const validateResponse = await fetch([process.env.BASE_URL || 'https://lumicon.chat', 'api/verify'].join('/'), {
        method: 'POST',
        headers: {
...
export default async function LoginPage(props: {
    ...
    const { from, lang } = await props.searchParams;
