...
export const BrainIcon = ({ className = "" }: { className?: string }) => (
  ...
  >
    ...
    />
    <path
      d="M15 9C15.5523 9 16 8.55228 16 8C16 7.44772 15.5523 7 15 7C14.4477 7 14 7.44772 14 8C14 8.55228 14.4477 9 15 9Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const InterfaceIcon = ({ className = "" }: { className?: string }) => (
  ...
  >
    <path
      d="M22 9H2M14 17H16M6 13H16M6 5H8"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ConnectIcon = ({ className = "" }: { className?: string }) => (
  ...
  >
    <path
      d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.8 11.8 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24c.304-.143.662-.352 1.048-.625a11.8 11.8 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.54 1.54 0 0 0-1.044-1.263 62.5 62.5 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"
      fill="currentColor"
    />
  </svg>
);
...
export const ModelFeaturesIcon = ({
  className = "",
}: {
  className?: string;
}) => (
...
export const ObjectGenerationIcon = ({
  className = "",
}: {
  className?: string;
}) => (
...
export const StreamingIcon = ({ className = "" }: { className?: string }) => (
  ...
  >
    ...
    />
    <path
      d="M4.22 4.22l4.24 4.24"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M15.54 15.54l4.24 4.24"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    ...
    />
    <path
      d="M4.22 19.78l4.24-4.24"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M15.54 8.46l4.24-4.24"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
...
export const OpenRouterIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M16 2.66675L4 9.33341V22.6667L16 29.3334L28 22.6667V9.33341L16 2.66675ZM16 5.33341L24 10.0001V20.0001L16 24.6667L8 20.0001V10.0001L16 5.33341Z"
      fill="currentColor"
    />
  </svg>
);
